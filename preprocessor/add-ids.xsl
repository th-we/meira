<?xml version="1.0"?>
<stylesheet version="1.0" xmlns="http://www.w3.org/1999/XSL/Transform" xmlns:mei="http://www.music-encoding.org/ns/mei">
  ...
  <template match="*" mode="get-id">
    ...
    <value-of select="concat(
          ...
          '_',
          $local-name,
          count(preceding-sibling::mei:*[local-name()=$local-name])+1
        )"
    />
